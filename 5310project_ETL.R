...
summary(df_company_product_table)
...
summary(df_product_category_table)
...
summary(df_category_contract_table)
...
summary(df_company_contract_table)
...
summary(df_keyword_contract_table)
...
summary(df_price_contract_table)
...
summary(df_price_monitor_table)
...
summary(df_sentiment_monitor_table)
...
summary(df_category_keyword_summary_table)
...
summary(df_category_sentiment_summary_table)
...
summary(df_product_keyword_summary_table)
...
summary(df_product_sentiment_summary_table)
...
head(df_price_contract_table)
which(duplicated(df_price_contract_table$price_contract_id))
###the price_contract_id column should be a constant integer without duplicated values but it has duplicated values right now, which means it can't be Primary Key, so we should create a new price_contract_id
...
###As we can see, there are many null values in those sentiment columns, so we should drop null values then find median value.
